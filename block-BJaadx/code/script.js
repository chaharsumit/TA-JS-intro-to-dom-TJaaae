...
document.body.children[0] // selects the h1 tag of the page

//    - Select the `h1` element and change the value to `Learning DOM`
document.body.children[0].innerText = "Learning DOM";

//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`
document.querySelector('.topics .list').innerText = "all about document";
...
allTopics.forEach(x => console.log(x.innertext));
...
console.log(document.querySelector([type = "submit"]).length);
...
console.log(topics[0].nextSibling);

// 23. Select the previous element sibling of the element stored in `topics` variable (#5) and change the `innerText` property to `Learning About Walking the DOM`.
console.log(topics[0].previousSibling = `Learning About Walking the DOM`);

// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
topics[0].innerText = `This is the first child element`;

// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.
console.log(typeof topics[0].lastElementChild);
